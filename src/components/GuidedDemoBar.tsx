    ...
    <div className="bg-white border-t border-blue-200 px-4 py-2.5 shadow-lg fixed bottom-0 left-0 right-0 z-40 flex flex-col md:flex-row items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2.5 sm:gap-3 w-full md:w-auto min-w-0">
        ...
        <div className="min-w-0 flex-1">
          <h4 className="text-xs md:text-sm font-bold text-slate-900 flex flex-wrap items-center gap-1.5 sm:gap-2">
            <span className="truncate">{currentConfig.title}</span>
            <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-rose-50 text-rose-700 border border-rose-200 shrink-0">
              REC-10231
            </span>
          </h4>
